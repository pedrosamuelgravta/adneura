...
def run_seed_for_user(user):
    ...
    if created:
        ...
        brand_info.key_characteristics = """- Innovative storytelling: Hulu's 'Only Murders in The Building' combines compelling narratives with unique experiences, setting a new standard for television.
